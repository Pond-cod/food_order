  ...
  return (
    <div className="row g-2 mb-3">
      <div className="col-12 col-sm-6">
        <label className="form-label fw-bold text-dark d-flex align-items-center gap-2 mb-1" style={{ fontSize: '13px' }}>
          <span 
        ...
        <div className="position-relative">
          <input
            ...
            inputMode="numeric"
            autoComplete="tel"
            className="form-control py-2 ps-3 shadow-sm rounded-3 bg-white"
            placeholder="เช่น 0812345678"
            value={phone}
            onChange={(e) => setPhone(e.target.value)}
            style={{ fontSize: '13.5px', border: '1.5px solid #E2E8F0' }}
          />
        </div>
      </div>
      <div className="col-12 col-sm-6">
